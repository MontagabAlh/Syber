...
export default function HeroContent() {
    return (
        <div className='flex flex-col md:justify-center items-center gap-5 w-full'>
            <h1 className='text-[30px] md:text-[40px] font-semibold'>مركز البياات</h1>
            <p className='text-center max-w-3xl'>كلام و وصف للاستضافات المشتركة كلام و وصف للاستضافات المشتركة كلام و وصف للاستضافات  كلام و   المشتركة كلام و وصف للاستضافات المشتركة </p>
