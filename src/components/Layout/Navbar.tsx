...
export default function Navbar() {
    ...
    return (
        <div className='fixed top-0 flex justify-between items-center w-full h-[85px] bg-white font-cairo px-2 md:p-[15px] lg:p-[29px]'>
            <div className='flex items-center gap-[10px] md:gap-[10px] lg:gap-[40px]'>
                <h1 className='text-[30px] md:text-[35px] lg:text-[40px] font-semibold'>Logo</h1>
